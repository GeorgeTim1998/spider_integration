...
#%% Plot data needed from Spider
  ...
  return r_mesh, z_mesh, psi_mesh
  sup.countour_plot_maxtrix(r_mesh, z_mesh, psi_mesh, levels=[0.001, 0.002, 0.003, 0.01], grid=True, colorbar=True, note='3D countour plot from Spider saved to PATH:', PATH=pic_path, plot_title='Spider', xlim=[1.5, 1.52], ylim=[-0.05, 0.05])
