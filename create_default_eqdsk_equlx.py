...
pres, fpol = eq.restore_pres_n_fpol(UM, UP, MESHR, pprime, ffprim, (2.96)**0.5, (2.96)**0.5)

pyplot.scatter(np.linspace(0, 1, len(ffprim)), ffprim/fpol)
pyplot.ylabel('fprim')
pyplot.xlabel('psi')
pyplot.grid(True)
pyplot.savefig('/media/george/part/Science/Pics/try_to_restore_pres_fpol_from_ders/fprime.png', dpi=240)
exit()
